...
public class Populator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Destination destin = new Destination("Destin, Florida", "/images/destin_Florida.jpeg", "destin beach", "Destin is located in the Florida Panhandle and is known for its white sandy beaches and beautiful clear blue turquoise water.", destinCategories,destinHashtags);
        ...
        Destination myrtleBeach = new Destination("Myrtle Beach, South Carolina", "/images/myrtle.jpeg","myrtle beach", "Part of the ‘Grand Strand’, Myrtle Beach is the hub of a 60-mile string of beaches. It boasts designer golf courses and plenty of family-friendly amenities.", myrtleCategories, myrtleHashtags);
        ...
        Destination tetons = new Destination("Teton Range, Wyoming", "/images/teton.jpeg","teton range", "The Teton Range, located on the border of Wyoming and Idaho is known for its jagged peaks and breathtaking views.", tetonCategories, tetonHashtags);
        ...
        Destination whiteMountains = new Destination("White Mountains, New Hampshire", "/images/whitemtns.jpeg","white mountains", "The White Mountains are a year-round destination filled with national and state parks that provide ample opportunities for skiing and hiking.", whiteMtnCategories, whiteMtnHashtags);
        ...
        Destination paris = new Destination("Paris, France", "/images/Eiffel-Tower_GettyImages-1060266626 copy.jpg","Eiffel Tower","Also known as the Latin Quarter, Paris is home to the Sorbonne university and vibrant cafes. The Eiffel Tower is a must see in addition to the famed Shakespeare & Company bookshop.", parisCategories, parisHashtags);
        ...
        Destination disney = new Destination("Disney Cruise Line", "/images/DCL-Disney-Wish-Rendering.jpeg","Disney Cruise Ship","Disney cruise lines provides entertainment for the whole family!", disneyCategories, disneyHashtags);
        ...
        Destination carnival = new Destination("Carnival Cruise Line", "/images/Carnival-cruise-line-military-cruise-deals-discount-4.jpeg","Carnival Cruise Ship", "Carnival Cruise lines are non-stop fun on your way to beautiful sunny destinations.", carnivalCategories, carnivalHashtags);
